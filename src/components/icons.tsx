...
function base(children: React.ReactNode, strokeWidth = 1.8) {
...
export const ChalkboardIcon = base(
  <>
...
export const ChevronDownIcon = base(<polyline points="6 9 12 15 18 9" />, 2.2);
export const ChevronLeftIcon = base(<polyline points="15 18 9 12 15 6" />, 3);
export const ChevronRightIcon = base(<polyline points="9 18 15 12 9 6" />, 3);
