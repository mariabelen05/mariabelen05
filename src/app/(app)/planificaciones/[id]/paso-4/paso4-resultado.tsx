  ...
  return (
    <div className="flex flex-col gap-6 pb-16">
      ...
      <section className="flex flex-col gap-2 rounded-2xl border border-border bg-card p-5">
        ...
        <p className="text-[13px] text-text">{objetivos.objetivoGeneral.texto}</p>
      ...
      <section className="flex flex-col gap-2 rounded-2xl border border-border bg-card p-5">
        ...
        <p className="text-[13px] font-bold text-text">{metodologia.metodologia.texto}</p>
        <div className="grid gap-3 sm:grid-cols-3">
          {(["inicio", "desarrollo", "cierre"] as const).map((k) => (
            <div key={k} className="rounded-xl bg-surface p-3">
              ...
              <p className="text-xs text-text">{metodologia.actividades[k].consigna}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="flex flex-col gap-2 rounded-2xl border border-border bg-card p-5">
        ...
        <p className="text-[13px] font-bold text-text">{evaluacion.instrumento.texto}</p>
        <ul className="list-inside list-disc text-[13px] text-text-faint">
